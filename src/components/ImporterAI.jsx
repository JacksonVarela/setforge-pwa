...
export default function ImporterAI({ onConfirm, onCancel }) {
  ...
  async function handleFile(e) {
    ...
    alert("Please upload .txt or .md for now. (PDF/DOCX coming later.)");
  }
      ...
      <section className="rounded-2xl border border-neutral-800 p-4 anime-overlay bg-import">
        <div className="max-w-screen-sm mx-auto">
          ...
          <p className="text-sm text-neutral-400">
            Paste free-form text, or upload a <strong>.txt / .md</strong> file. AI will detect days & exercises.
          </p>
          ...
          <div className="mt-3 grid gap-2">
            ...
            />
            <div className="text-sm text-neutral-400">Or upload:</div>
            <input type="file" accept=".txt,.md,.markdown,text/plain" onChange={handleFile} />
          </div>
    ...
    <section className="rounded-2xl border border-neutral-800 p-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button className="btn" onClick={() => setPhase("paste")}>
            Back
          </button>
          <button
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {it.type === "exercise" && (
                      <>
                        ...
                        <select
                          className="input w-auto"
                          value={it.isCompound ? "compound" : "isolation"}
                          onChange={(e) => {
                            const next = structuredClone(days);
                        ...
                        <button className="btn" onClick={() => enrichRow(di, ii)}>
                          AI fill
                        </button>
                      </>
                    )}
